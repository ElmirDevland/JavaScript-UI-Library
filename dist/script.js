...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#first').click(() => {
  (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.container').find('div').eq(0).fadeToggle(600);
});
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-count="second"]').click(() => {
  (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.container').find('div').eq(1).fadeToggle(600);
});
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').eq(2).click(() => {
  (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.w-500px').fadeToggle(600);
});
}();
/******/ })()
;
